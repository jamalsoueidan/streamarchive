...
export function VideoPlayer({
  ...
  // requires. Shared queryKey with parent modal pages so it dedupes.
  ...
  if (!canPlay) {
    // Parent modals/pages handle the upgrade UI via the same query key.
    // Don't request the playlist here.
    return null;
  }
